<!-- FILL THIS ASAP (MAINLY DID OCI AND CLEANING OF BOOKMARKS FROM PHONE AND PC TABS AND FOUND MANY RESOURCES)
also start github foundations course on microsoft learn and get github foundations certificate along with oci (plan)
 -->
